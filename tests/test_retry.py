# tests/test_retry.py
#
# Tests for the exponential backoff retry logic in BaseAgent._call_claude().
# We mock the Anthropic client to simulate API errors without making real calls.
...
class TestRetryLogic:
    """Tests for _call_claude retry with exponential backoff."""
    ...
    def test_success_on_first_try(self, mock_client):
        ...
        result = self.agent._call_claude()
